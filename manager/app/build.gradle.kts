...
val defaultManagerPackageName = if (isPrBuild) "com.kiran.manage.pr" else "com.kiran.manage"
val defaultManagerName = if (isPrBuild) "File Manager PR" else "File Manager"
