...
import com.kiran.manage.core.tasks.BootKernelVersion
import com.kiran.manage.core.tasks.ExtractImage
import com.kiran.manage.core.tasks.ProbeResult
import com.kiran.manage.core.utils.DataSourceChannel
...
fun flashModule(
    ...
    with(resolver.openInputStream(uri)) {
        ...
        Log.i("FileMgr", "install module $uri result: $result")
...
fun runModuleAction(
    ...
    Log.i("FileMgr", "Module runAction result: $result")
...
fun installBoot(
    ...
    val result = flashWithIO("${getKsuDaemonPath()} $cmd", onStdout, onStderr)
    Log.i("FileMgr", "install boot result: ${result.isSuccess}")
